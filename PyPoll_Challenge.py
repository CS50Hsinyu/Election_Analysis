...
county_largestvotes = 0
county_largestpercentage =0
...
with open(file_to_save, "w") as txt_file:
    ...
    for county_name in  county_votes:
        ...
        county_result =(f"{county_name}: {county_percentage:.1f}% ({votes:,})\n")
        print(county_result, end="")
         # 6e: Save the county votes to a text file.
        txt_file.write(county_result)
         # 6f: Write an if statement to determine the winning county and get its vote count.
        if (votes > county_largestvotes):
            county_largestvotes= votes
            county_largestturnout=county_name
            county_largestpercentage=county_percentage
